...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006d9e47e4000000001569b025(
...
class phpbbtemplatetwiglexer_000000006d9e47e4000000001569b025 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ad7fe03c4b04877629860 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ad7fe03c4b0d130874234 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ad7fe03c4ae8567180763 = array(
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, 'set_environment', array('env' => $env), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;

        return $this->valueHolder5ad7fe03c4b04877629860->set_environment($env);
    }
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;

        return $this->valueHolder5ad7fe03c4b04877629860->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;

        return $this->valueHolder5ad7fe03c4b04877629860->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 = $initializer;
    }
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, '__get', array('name' => $name), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;

        if (isset(self::$publicProperties5ad7fe03c4ae8567180763[$name])) {
            return $this->valueHolder5ad7fe03c4b04877629860->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ad7fe03c4b04877629860;
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, '__isset', array('name' => $name), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, '__unset', array('name' => $name), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;
    ...
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, '__clone', array(), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;

        $this->valueHolder5ad7fe03c4b04877629860 = clone $this->valueHolder5ad7fe03c4b04877629860;
    }

    public function __sleep()
    {
        $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, '__sleep', array(), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;

        return array('valueHolder5ad7fe03c4b04877629860');
    }
    ...
    {
        return $this->initializer5ad7fe03c4b0d130874234;
    }
    ...
    {
        return $this->initializer5ad7fe03c4b0d130874234 && ($this->initializer5ad7fe03c4b0d130874234->__invoke($valueHolder5ad7fe03c4b04877629860, $this, 'initializeProxy', array(), $this->initializer5ad7fe03c4b0d130874234) || 1) && $this->valueHolder5ad7fe03c4b04877629860 = $valueHolder5ad7fe03c4b04877629860;
    }
    ...
    {
        return null !== $this->valueHolder5ad7fe03c4b04877629860;
    }
    ...
    {
        return $this->valueHolder5ad7fe03c4b04877629860;
    }
